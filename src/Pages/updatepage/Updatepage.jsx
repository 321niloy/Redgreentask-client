...
const Updatepage = () =>{
    ...
    const onSubmit = (data) => {
        console.log(data)
        const url = `/updatedata/${getdata._id}`
        Axios.put(url,data)
        .then(res =>{
            console.log("data posted successfull check",res)
            Swal.fire('Data update Successfull')
         })
         .catch(error =>{
            console.log(error)
         })
...
return(
    <div>
        <h1 className="text-5xl text-sky-700 my-5">Edit Details</h1>
    ...
    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-sky-600 bg-opacity-40">
      <form onSubmit={handleSubmit(onSubmit)} className="card-body">
        <div className="form-control">
          ...
          <input type="text" placeholder="Name" {...register("name", { required: true })} className="input input-bordered" defaultValue={getdata?.name}/>
        ...
        <div className="form-control">
          ...
          <input type="number" placeholder="Age" {...register("age", { required: true })} className="input input-bordered"  defaultValue={getdata?.age}/>
        ...
        <input type="text" placeholder="Location" {...register("location", { required: true })} className="input input-bordered"  defaultValue={getdata?.location}/>
        ...
        <div className="form-control">
          ...
          <input type="number" placeholder="Number" {...register("number", { required: true })} className="input input-bordered"  defaultValue={getdata?.number}/>
        ...
        <div className="form-control">
          ...
          <input type="number" placeholder="NID" {...register("nid", { required: true })} className="input input-bordered" defaultValue={getdata?.nid}/>
